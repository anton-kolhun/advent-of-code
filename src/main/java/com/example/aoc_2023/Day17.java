...
public class Day17 {
    ...
    private static int dejkstraUpdated(Map<Coordinate, Integer> coords, Coordinate start, Coordinate end, List<String> lines) {
        ...
        while (!priorityQueue.isEmpty()) {
            ...
            List<CoordInfo> nextCoords = getAllowdNeighbours(coordMin, coords, lines);
    ...
    private static List<CoordInfo> getAllowdNeighbours(CoordInfo coordMin, Map<Coordinate, Integer> coords, List<String> lines) {
