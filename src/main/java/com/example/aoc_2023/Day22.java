...
//        System.out.println();
    ...
    private static void processBricks(Map<Coordinate, Integer> coordToBrick, Map<Integer, List<Coordinate>> brickToCoord, Map<Integer, Set<Integer>> deps) {
        //print(brickToCoord, coordToBrick);
        Set<Integer> visited = new HashSet<>();
        Map<Integer, List<Integer>> deps2 = new HashMap<>();
        while (visited.size() != brickToCoord.keySet().size()) {
            ...
            for (Integer connected : connectedBricksAbove) {
                deps.merge(connected, Set.of(minZInd), (integers, integers2) -> {
            ...
            deps2.put(minZInd, new ArrayList<>(connectedBricksAbove));
            visited.add(minZInd);
        }
...
//        }
        ...
        var totalToRemove = new HashSet<>(noRemove);
        // totalToRemove.addAll(bricksWitNoAbove);
        System.out.println(brickToCoord.size() - totalToRemove.size());
